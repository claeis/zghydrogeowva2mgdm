...
{
  public final static String tag= "Grundwasseraustritte_LV95_V1.Grundwasseraustritte.Quelle";
  ...
  public Double getSchuettung_minimal() {
    if(getattrvaluecount("Schuettung_minimal")==0)return null;
    String value=getattrvalue("Schuettung_minimal");
    return Double.parseDouble(value);
  }
  public void setSchuettung_minimal(Double value) {
    if(value==null){setattrundefined("Schuettung_minimal");return;}
