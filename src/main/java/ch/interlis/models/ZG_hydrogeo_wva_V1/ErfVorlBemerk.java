...
public class ErfVorlBemerk{
  ...
  protected ErfVorlBemerk(String value) {
    this.value=value;
  ...
  static public ErfVorlBemerk GPS_10_00m=new ErfVorlBemerk("GPS_10_00m");
  public final static String tag_GPS_10_00m="GPS_10_00m";
