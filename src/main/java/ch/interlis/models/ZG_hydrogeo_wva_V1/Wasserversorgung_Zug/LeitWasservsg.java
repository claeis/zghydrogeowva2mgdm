...
public class LeitWasservsg extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_hydrogeo_wva_V1.Wasserversorgung_Zug.LeitWasservsg";
  public LeitWasservsg(String oid) {
    super(tag,oid);
  }
