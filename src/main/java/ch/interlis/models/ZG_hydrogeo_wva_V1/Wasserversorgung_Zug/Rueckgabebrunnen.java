...
{
  public final static String tag= "ZG_hydrogeo_wva_V1.Wasserversorgung_Zug.Rueckgabebrunnen";
  ...
  public ch.interlis.models.ZG_hydrogeo_wva_V1.VersickerungTyp getTyp() {
    if(getattrvaluecount("Typ")==0)return null;
  ...
  public void setTyp(ch.interlis.models.ZG_hydrogeo_wva_V1.VersickerungTyp value) {
    if(value==null){setattrundefined("Typ");return;}
