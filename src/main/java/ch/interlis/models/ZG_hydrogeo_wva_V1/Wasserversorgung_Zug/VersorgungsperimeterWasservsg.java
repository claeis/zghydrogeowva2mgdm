...
public class VersorgungsperimeterWasservsg extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_hydrogeo_wva_V1.Wasserversorgung_Zug.VersorgungsperimeterWasservsg";
  public VersorgungsperimeterWasservsg(String oid) {
    super(tag,oid);
  }
