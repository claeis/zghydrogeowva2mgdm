...
public class ResWasservsg extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_hydrogeo_wva_V1.Wasserversorgung_Zug.ResWasservsg";
  public ResWasservsg(String oid) {
    super(tag,oid);
  }
