...
public class FoerderanlageWasservsg extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_hydrogeo_wva_V1.Wasserversorgung_Zug.FoerderanlageWasservsg";
  public FoerderanlageWasservsg(String oid) {
    super(tag,oid);
  }
