...
{
  public final static String tag= "ZG_hydrogeo_wva_V1.Wasserversorgung_Zug.Uebergabestelle";
  ...
  public ch.interlis.models.ZG_hydrogeo_wva_V1.VerbundArt getVerbundArt() {
    String value=getattrvalue("VerbundArt");
    return ch.interlis.models.ZG_hydrogeo_wva_V1.VerbundArt.parseXmlCode(value);
  }
  public void setVerbundArt(ch.interlis.models.ZG_hydrogeo_wva_V1.VerbundArt value) {
    setattrvalue("VerbundArt", ch.interlis.models.ZG_hydrogeo_wva_V1.VerbundArt.toXmlCode(value));
  }
  ...
  public Uebergabestelle_ObjektArt getObjektArt() {
    if(getattrvaluecount("ObjektArt")==0)return null;
    String value=getattrvalue("ObjektArt");
    return Uebergabestelle_ObjektArt.parseXmlCode(value);
  }
  public void setObjektArt(Uebergabestelle_ObjektArt value) {
    if(value==null){setattrundefined("ObjektArt");return;}
    setattrvalue("ObjektArt", Uebergabestelle_ObjektArt.toXmlCode(value));
  }
