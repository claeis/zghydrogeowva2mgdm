...
public class ResTechDataText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ResTechDataText";
  public ResTechDataText(String oid) {
    super(tag,oid);
  }
