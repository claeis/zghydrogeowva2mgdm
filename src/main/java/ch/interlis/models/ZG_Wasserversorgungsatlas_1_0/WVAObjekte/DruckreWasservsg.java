...
public class DruckreWasservsg extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.DruckreWasservsg";
  public DruckreWasservsg(String oid) {
    super(tag,oid);
  }
