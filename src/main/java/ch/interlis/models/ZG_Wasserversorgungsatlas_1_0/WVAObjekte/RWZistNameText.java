...
public class RWZistNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.RWZistNameText";
  public RWZistNameText(String oid) {
    super(tag,oid);
  }
  ...
  public String setRWZisterne(String oid) {
    ch.interlis.iom.IomObject structvalue=getattrobj("RWZisterne",0);
    if(structvalue==null){
      if(oid==null)return null;
      structvalue=addattrobj("RWZisterne","REF");
    }else{
      if(oid==null){
        String oldoid=structvalue.getobjectrefoid();
        deleteattrobj("RWZisterne",0);
        return oldoid;
      }
    }
    String oldoid=structvalue.getobjectrefoid();
