...
public class ResNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ResNameText";
  public ResNameText(String oid) {
    super(tag,oid);
  }
