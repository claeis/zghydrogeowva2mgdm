...
public class SaSchaNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.SaSchaNameText";
  public SaSchaNameText(String oid) {
    super(tag,oid);
  }
