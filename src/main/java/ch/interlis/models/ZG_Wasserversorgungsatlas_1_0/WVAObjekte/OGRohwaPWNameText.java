...
public class OGRohwaPWNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.OGRohwaPWNameText";
  public OGRohwaPWNameText(String oid) {
    super(tag,oid);
  }
