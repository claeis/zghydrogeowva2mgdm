...
public class EntbruNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.EntbruNameText";
  public EntbruNameText(String oid) {
    super(tag,oid);
  }
