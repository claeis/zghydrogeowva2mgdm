...
public class PWTechData4Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTechData4Text";
  public PWTechData4Text(String oid) {
    super(tag,oid);
  }
