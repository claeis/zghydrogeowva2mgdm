...
public class PWNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWNameText";
  public PWNameText(String oid) {
    super(tag,oid);
  }
