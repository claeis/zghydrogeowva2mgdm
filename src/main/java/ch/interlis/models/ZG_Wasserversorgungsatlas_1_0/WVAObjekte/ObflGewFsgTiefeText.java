...
public class ObflGewFsgTiefeText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ObflGewFsgTiefeText";
  public ObflGewFsgTiefeText(String oid) {
    super(tag,oid);
  }
  ...
  public final static String tag_OberflGewFsg="OberflGewFsg";
  public String getOberflGewFsg() {
    ch.interlis.iom.IomObject value=getattrobj("OberflGewFsg",0);
    if(value==null)return null;
    String oid=value.getobjectrefoid();
    if(oid==null)return null;
    return oid;
  }
  public String setOberflGewFsg(String oid) {
    ch.interlis.iom.IomObject structvalue=getattrobj("OberflGewFsg",0);
    if(structvalue==null){
      if(oid==null)return null;
      structvalue=addattrobj("OberflGewFsg","REF");
    }else{
      if(oid==null){
        String oldoid=structvalue.getobjectrefoid();
        deleteattrobj("OberflGewFsg",0);
        return oldoid;
      }
    }
    String oldoid=structvalue.getobjectrefoid();
