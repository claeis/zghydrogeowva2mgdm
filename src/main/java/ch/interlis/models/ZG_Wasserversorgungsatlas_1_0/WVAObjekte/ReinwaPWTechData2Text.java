...
public class ReinwaPWTechData2Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ReinwaPWTechData2Text";
  public ReinwaPWTechData2Text(String oid) {
    super(tag,oid);
  }
