...
public class Pumpwerk extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.Pumpwerk";
  public Pumpwerk(String oid) {
    super(tag,oid);
  }
  ...
  public ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTyp getTyp() {
    String value=getattrvalue("Typ");
    return ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTyp.parseXmlCode(value);
  }
  public void setTyp(ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTyp value) {
    setattrvalue("Typ", ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTyp.toXmlCode(value));
  }
