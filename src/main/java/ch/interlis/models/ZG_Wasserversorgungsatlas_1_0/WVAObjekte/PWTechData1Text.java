...
public class PWTechData1Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTechData1Text";
  public PWTechData1Text(String oid) {
    super(tag,oid);
  }
