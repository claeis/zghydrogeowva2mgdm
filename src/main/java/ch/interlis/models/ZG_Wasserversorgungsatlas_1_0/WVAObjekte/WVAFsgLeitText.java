...
public class WVAFsgLeitText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.WVAFsgLeitText";
  public WVAFsgLeitText(String oid) {
    super(tag,oid);
  }
