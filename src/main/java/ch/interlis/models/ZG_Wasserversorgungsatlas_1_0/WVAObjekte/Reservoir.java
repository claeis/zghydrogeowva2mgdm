...
public class Reservoir extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.Reservoir";
  ...
  public ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ResSymbTyp getSymbolTyp() {
    String value=getattrvalue("SymbolTyp");
    return ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ResSymbTyp.parseXmlCode(value);
  }
  public void setSymbolTyp(ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ResSymbTyp value) {
    setattrvalue("SymbolTyp", ch.interlis.models.ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ResSymbTyp.toXmlCode(value));
  }
  ...
  public final static String tag_WspHoehe="WspHoehe";
  public Double getWspHoehe() {
    if(getattrvaluecount("WspHoehe")==0)return null;
    String value=getattrvalue("WspHoehe");
    return Double.parseDouble(value);
  }
  public void setWspHoehe(Double value) {
    if(value==null){setattrundefined("WspHoehe");return;}
    setattrvalue("WspHoehe", Double.toString(value));
  }
  public final static String tag_Brauchreserve="Brauchreserve";
  public String getBrauchreserve() {
    if(getattrvaluecount("Brauchreserve")==0)return null;
    String value=getattrvalue("Brauchreserve");
    return value;
  }
  public void setBrauchreserve(String value) {
    if(value==null){setattrundefined("Brauchreserve");return;}
    setattrvalue("Brauchreserve", value);
  }
  public final static String tag_Loeschreserve="Loeschreserve";
  public String getLoeschreserve() {
    if(getattrvaluecount("Loeschreserve")==0)return null;
    String value=getattrvalue("Loeschreserve");
    return value;
  }
  public void setLoeschreserve(String value) {
    if(value==null){setattrundefined("Loeschreserve");return;}
    setattrvalue("Loeschreserve", value);
  }
  ...
  public String getStufenpumpwerk() {
    ch.interlis.iom.IomObject value=getattrobj("Stufenpumpwerk",0);
    if(value==null)return null;
    String oid=value.getobjectrefoid();
    if(oid==null)return null;
    return oid;
  }
  public String setStufenpumpwerk(String oid) {
    ch.interlis.iom.IomObject structvalue=getattrobj("Stufenpumpwerk",0);
    if(structvalue==null){
      if(oid==null)return null;
      structvalue=addattrobj("Stufenpumpwerk","REF");
    }else{
      if(oid==null){
        String oldoid=structvalue.getobjectrefoid();
        deleteattrobj("Stufenpumpwerk",0);
        return oldoid;
      }
    }
    String oldoid=structvalue.getobjectrefoid();
