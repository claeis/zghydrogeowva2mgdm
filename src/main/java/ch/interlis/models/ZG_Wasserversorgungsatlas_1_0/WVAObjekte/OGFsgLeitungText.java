...
public class OGFsgLeitungText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.OGFsgLeitungText";
  public OGFsgLeitungText(String oid) {
    super(tag,oid);
  }
  ...
  public String getOberflGewFsgLeitung() {
    ch.interlis.iom.IomObject value=getattrobj("OberflGewFsgLeitung",0);
    if(value==null)return null;
    String oid=value.getobjectrefoid();
    if(oid==null)return null;
    return oid;
  }
  public String setOberflGewFsgLeitung(String oid) {
    ch.interlis.iom.IomObject structvalue=getattrobj("OberflGewFsgLeitung",0);
    if(structvalue==null){
      if(oid==null)return null;
      structvalue=addattrobj("OberflGewFsgLeitung","REF");
    }else{
      if(oid==null){
        String oldoid=structvalue.getobjectrefoid();
        deleteattrobj("OberflGewFsgLeitung",0);
        return oldoid;
      }
    }
    String oldoid=structvalue.getobjectrefoid();
