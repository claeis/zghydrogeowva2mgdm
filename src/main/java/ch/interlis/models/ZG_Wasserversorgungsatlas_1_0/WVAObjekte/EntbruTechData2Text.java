...
public class EntbruTechData2Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.EntbruTechData2Text";
  public EntbruTechData2Text(String oid) {
    super(tag,oid);
  }
