...
public class ReinwaPWTechData4Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.ReinwaPWTechData4Text";
  public ReinwaPWTechData4Text(String oid) {
    super(tag,oid);
  }
