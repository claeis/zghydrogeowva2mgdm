...
public class QueSchaErtragBrstText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.QueSchaErtragBrstText";
  public QueSchaErtragBrstText(String oid) {
    super(tag,oid);
  }
