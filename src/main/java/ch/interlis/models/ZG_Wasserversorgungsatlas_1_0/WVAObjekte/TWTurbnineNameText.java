...
public class TWTurbnineNameText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.TWTurbnineNameText";
  public TWTurbnineNameText(String oid) {
    super(tag,oid);
  }
