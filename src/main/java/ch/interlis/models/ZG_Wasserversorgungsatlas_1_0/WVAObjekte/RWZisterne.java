...
public class RWZisterne extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.RWZisterne";
  public RWZisterne(String oid) {
    super(tag,oid);
  }
