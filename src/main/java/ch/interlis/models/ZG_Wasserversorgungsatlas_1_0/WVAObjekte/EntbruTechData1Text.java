...
public class EntbruTechData1Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.EntbruTechData1Text";
  public EntbruTechData1Text(String oid) {
    super(tag,oid);
  }
