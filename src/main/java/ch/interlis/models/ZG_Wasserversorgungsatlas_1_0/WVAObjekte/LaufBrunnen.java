...
public class LaufBrunnen extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.LaufBrunnen";
  public LaufBrunnen(String oid) {
    super(tag,oid);
  }
