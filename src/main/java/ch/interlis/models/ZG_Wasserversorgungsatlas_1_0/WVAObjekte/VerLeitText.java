...
public class VerLeitText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.VerLeitText";
  public VerLeitText(String oid) {
    super(tag,oid);
  }
