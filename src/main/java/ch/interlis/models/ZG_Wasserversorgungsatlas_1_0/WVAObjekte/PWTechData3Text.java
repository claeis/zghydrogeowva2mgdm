...
public class PWTechData3Text extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.PWTechData3Text";
  public PWTechData3Text(String oid) {
    super(tag,oid);
  }
