...
public class AufbWkrFilterLeistText extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasserversorgungsatlas_1_0.WVAObjekte.AufbWkrFilterLeistText";
  public AufbWkrFilterLeistText(String oid) {
    super(tag,oid);
  }
