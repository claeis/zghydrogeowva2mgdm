...
public class QuellSchWasservsg extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.QuellSchWasservsg";
  public QuellSchWasservsg(String oid) {
    super(tag,oid);
  }
