...
public class AbWaEinleitDatei extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.AbWaEinleitDatei";
  public AbWaEinleitDatei(String oid) {
    super(tag,oid);
  }
