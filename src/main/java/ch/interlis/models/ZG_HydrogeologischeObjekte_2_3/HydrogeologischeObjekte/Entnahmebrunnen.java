...
{
  public final static String tag= "ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.Entnahmebrunnen";
  ...
  public ch.interlis.models.ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.EntnahmebrunnenTyp getTyp() {
    String value=getattrvalue("Typ");
    return ch.interlis.models.ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.EntnahmebrunnenTyp.parseXmlCode(value);
  }
  public void setTyp(ch.interlis.models.ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.EntnahmebrunnenTyp value) {
    setattrvalue("Typ", ch.interlis.models.ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.EntnahmebrunnenTyp.toXmlCode(value));
  }
  ...
  public final static String tag_FilterrohrDimension="FilterrohrDimension";
  public Integer getFilterrohrDimension() {
    if(getattrvaluecount("FilterrohrDimension")==0)return null;
    String value=getattrvalue("FilterrohrDimension");
    return Integer.parseInt(value);
  }
  public void setFilterrohrDimension(Integer value) {
    if(value==null){setattrundefined("FilterrohrDimension");return;}
    setattrvalue("FilterrohrDimension", Integer.toString(value));
  }
