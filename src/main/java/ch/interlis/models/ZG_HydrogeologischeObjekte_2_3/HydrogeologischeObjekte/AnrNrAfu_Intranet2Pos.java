...
public class AnrNrAfu_Intranet2Pos extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.AnrNrAfu_Intranet2Pos";
  public AnrNrAfu_Intranet2Pos(String oid) {
    super(tag,oid);
  }
