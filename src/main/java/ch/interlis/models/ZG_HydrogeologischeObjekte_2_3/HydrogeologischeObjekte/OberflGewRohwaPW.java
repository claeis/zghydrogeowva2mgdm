...
{
  public final static String tag= "ZG_HydrogeologischeObjekte_2_3.HydrogeologischeObjekte.OberflGewRohwaPW";
  ...
  public OberflGewRohwaPW_Typ getTyp() {
    String value=getattrvalue("Typ");
    return OberflGewRohwaPW_Typ.parseXmlCode(value);
  }
  public void setTyp(OberflGewRohwaPW_Typ value) {
    setattrvalue("Typ", OberflGewRohwaPW_Typ.toXmlCode(value));
  }
