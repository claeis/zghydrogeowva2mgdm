...
{
  public final static String tag= "ZG_Wasser_V1.Wasserversorgung_Zug.BautenGW";
  ...
  public ch.interlis.models.ZG_Wasser_V1.BautenGWTyp getTyp() {
    String value=getattrvalue("Typ");
    return ch.interlis.models.ZG_Wasser_V1.BautenGWTyp.parseXmlCode(value);
  }
  public void setTyp(ch.interlis.models.ZG_Wasser_V1.BautenGWTyp value) {
    setattrvalue("Typ", ch.interlis.models.ZG_Wasser_V1.BautenGWTyp.toXmlCode(value));
  }
