...
public class Einleit extends ch.interlis.iom_j.Iom_jObject
{
  public final static String tag= "ZG_Wasser_V1.Wasserversorgung_Zug.Einleit";
  public Einleit(String oid) {
    super(tag,oid);
  }
  ...
  public ch.interlis.models.ZG_Wasser_V1.BetriebsArt getBetriebArt() {
    String value=getattrvalue("BetriebArt");
    return ch.interlis.models.ZG_Wasser_V1.BetriebsArt.parseXmlCode(value);
  }
  public void setBetriebArt(ch.interlis.models.ZG_Wasser_V1.BetriebsArt value) {
    setattrvalue("BetriebArt", ch.interlis.models.ZG_Wasser_V1.BetriebsArt.toXmlCode(value));
  }
