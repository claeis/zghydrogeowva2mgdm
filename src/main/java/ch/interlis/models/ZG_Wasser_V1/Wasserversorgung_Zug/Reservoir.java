...
{
  public final static String tag= "ZG_Wasser_V1.Wasserversorgung_Zug.Reservoir";
  ...
  public ch.interlis.models.ZG_Wasser_V1.ResSymbTyp getSymbolTyp() {
    String value=getattrvalue("SymbolTyp");
    return ch.interlis.models.ZG_Wasser_V1.ResSymbTyp.parseXmlCode(value);
  }
  public void setSymbolTyp(ch.interlis.models.ZG_Wasser_V1.ResSymbTyp value) {
    setattrvalue("SymbolTyp", ch.interlis.models.ZG_Wasser_V1.ResSymbTyp.toXmlCode(value));
  }
