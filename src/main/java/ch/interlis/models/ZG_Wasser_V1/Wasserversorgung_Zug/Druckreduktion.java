...
public class Druckreduktion extends ch.interlis.models.ZG_Wasser_V1.Wasserversorgung_Zug.Schieberschacht
{
  public final static String tag= "ZG_Wasser_V1.Wasserversorgung_Zug.Druckreduktion";
  ...
  public ch.interlis.models.ZG_Wasser_V1.DruckRedTyp getTyp() {
    String value=getattrvalue("Typ");
    return ch.interlis.models.ZG_Wasser_V1.DruckRedTyp.parseXmlCode(value);
  }
  public void setTyp(ch.interlis.models.ZG_Wasser_V1.DruckRedTyp value) {
    setattrvalue("Typ", ch.interlis.models.ZG_Wasser_V1.DruckRedTyp.toXmlCode(value));
  }
